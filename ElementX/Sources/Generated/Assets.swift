...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal static let homeProfileIcon = ImageAsset(name: "images/home-profile-icon")
    internal static let homeTabChatFilledIcon = ImageAsset(name: "images/home-tab-chat-filled-icon")
    ...
    internal static let homeTabNotificationFilledIcon = ImageAsset(name: "images/home-tab-notification-filled-icon")
    internal static let homeTabNotificationIcon = ImageAsset(name: "images/home-tab-notification-icon")
    internal static let homeTabWalletFilledIcon = ImageAsset(name: "images/home-tab-wallet-filled-icon")
    internal static let homeTabWalletIcon = ImageAsset(name: "images/home-tab-wallet-icon")
    internal static let iconBack = ImageAsset(name: "images/icon-back")
    internal static let iconChainAvax = ImageAsset(name: "images/icon-chain-avax")
    internal static let iconChainBase = ImageAsset(name: "images/icon-chain-base")
    internal static let iconChainEthereum = ImageAsset(name: "images/icon-chain-ethereum")
    internal static let iconChainPolygon = ImageAsset(name: "images/icon-chain-polygon")
    internal static let iconChainSolana = ImageAsset(name: "images/icon-chain-solana")
    internal static let iconChainZ = ImageAsset(name: "images/icon-chain-z")
    ...
    internal static let iconDefaultNft = ImageAsset(name: "images/icon_default_nft")
    ...
    internal static let landingPagerImage1 = ImageAsset(name: "images/landing-pager-image-1")
    internal static let landingPagerImage2 = ImageAsset(name: "images/landing-pager-image-2")
    internal static let landingPagerImage3 = ImageAsset(name: "images/landing-pager-image-3")
    internal static let landingPagerImage4 = ImageAsset(name: "images/landing-pager-image-4")
    internal static let logoApple = ImageAsset(name: "images/logo-apple")
    internal static let logoEmail = ImageAsset(name: "images/logo-email")
    internal static let logoEpic = ImageAsset(name: "images/logo-epic")
    internal static let logoGoogle = ImageAsset(name: "images/logo-google")
    internal static let logoWalletConnect = ImageAsset(name: "images/logo-wallet-connect")
    internal static let logoX = ImageAsset(name: "images/logo-x")
